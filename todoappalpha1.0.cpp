...
int main() {
    ...
    // Pārbaud vai ievadītais numurs ir 1-3
    ...
    vector<Task> dayTasks = {
        {"Pievilksanas pie stienas", "Diena"},
        {"Pumpēšana", "Diena"},
        {"Jumping Jacks", "Diena"},
    ...
    cout << "Vai esi fiziski stiprs? (1-3): ";
    cin >> physicalStrength;

    // Nosaka katras aktivitātes laiku atkarībā no fiziskās spējas
